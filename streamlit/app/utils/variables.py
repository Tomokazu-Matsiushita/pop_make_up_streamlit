...
#def fnc1(target_year, target_month):
def fnc1(target_date):
  target_year = target_date.year
  target_month = target_date.month
  this_month_trn = trn[ (trn['DATE'].dt.year == target_year) & (trn['DATE'].dt.month == target_month) ]  #指定月のtransitionデータ
